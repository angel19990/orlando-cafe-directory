        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {NEIGHBORHOODS.map(({ area, label, image }) => (
            <Link
              key={area}
              href={`/area/${area}`}
              className="group overflow-hidden rounded-2xl border-2 border-[#252525] bg-white shadow-[4px_4px_0px_0px_#B5450F] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"
            >
