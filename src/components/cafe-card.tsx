...
export function CafeCard({ cafe }: { cafe: CafeCardType }) {
  ...
  return (
    <Link href={`/cafes/${cafe.slug.current}`} className="group block">
      <div className="h-full overflow-hidden rounded-2xl border-2 border-[#252525] bg-white shadow-[4px_4px_0px_0px_#B5450F] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
        {/* Cover image */}
